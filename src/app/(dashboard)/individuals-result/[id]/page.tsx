...
import { ArrowLeft, User, Brain, PieChart, Lightbulb, Briefcase, GraduationCap, BookOpen, School, CheckSquare, Heart, FileText } from 'lucide-react';
...
import { TendencyTab } from '@/components/result/TendencyTab';
    ...
    <div className="container mx-auto py-8 px-6 max-w-7xl">
      ...
      <Tabs defaultValue="personal" className="w-full">
        ...
        <TabsContent value="tendency">
          <TendencyTab loading={loading} error={error} data={data} />
        </TabsContent>
